...
class memberDataToCMS {
  ...
  getDataFromDoc() {
    return qs.stringify({
      ...
      //entityId: this.doc.account_id.domain.cmsId, //sponsorId
      sponsorId: this.doc.sponsorId, //sponsorId
      memberAccountId: this.doc.accountId, //memberAccountId
      // firstname: this.doc.account_id.first_name? this.doc.account_id.first_name.split(" ")[0] //name
      //   : this.doc.account_id.first_name,
      // lastname: this.doc.account_id.first_name ? this.doc.account_id.first_name.split(" ")[1]: "",
      // userName: "",
      email: this.decrypt(this.doc.accountAccessId.officialEmailID),
      phone: this.decrypt(this.doc.accountAccessId.primaryMobileNumber),
      employee_code : this.doc.account_id.employee_code?this.doc.account_id.employee_code:"",
      qr_code : this.doc.account_id.qr_code?this.doc.account_id.qr_code:"", //qrcode
...
module.exports = memberDataToCMS;
